...
{p2col :{hi:summtab} {hline 2}}Computes summary statistics overall and/or across levels of a categorical variable 
								...
								compiles them into a nicely formatted, publication-quality table.  See the program {cmd:{help summtab2}}
								if you want more control over where variables appear in the table.
